...
const rushDriver = localFont({
  src: "../public/fonts/RushDriver.otf",
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body
        className={`${montserrat.variable} ${inter.variable} ${rushDriver.variable} antialiased`}
      >
        <Header />
        {children}
        <ChatButton />
          ...
          <div className="max-w-6xl mx-auto px-4">
            <div className="grid gap-8 sm:grid-cols-3">
              ...
              <div>
                ...
                <a href="mailto:hamidsoccertraining@gmail.com" className="mt-1 block text-sm text-blue-300 hover:underline break-all">
              ...
              <div>
                ...
                <div className="mt-1 flex flex-col gap-1">
                  <a href="https://calendly.com/hamidsoccertraining" target="_blank" rel="noopener noreferrer" className="text-sm text-blue-300 hover:underline">
                    Reserve a Spot
                  </a>
                  <a href="https://www.instagram.com/hamid_soccertraining?igsh=MTVzcnVuMHFkdnk1eg==" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-sm text-pink-400 hover:underline">
